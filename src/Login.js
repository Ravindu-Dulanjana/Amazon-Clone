  ...
  return (
    ...
    <div className="login__container">
        ...
        <form >
            ...
            <h5>Password</h5>
            <input type="password" value={passowrd} onChange={(e) => setPassowrd(e.target.value)} />
        ...
        <p>
            By Signing-in you agree to Amazon's FAKE CLONE Conditions of Use & Sale. Pleace see out Privacy Notice, our Cookies Notice and our Interest-Based Ads
        </p>
